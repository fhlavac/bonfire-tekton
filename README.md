...
2. In case there is still not a directory for your tenant in the repo you just forked, you will need to create one under the directory `tenants-config/cluster/stone-prd-rh01/tenants/<your-workspace-name>-tenant`.
